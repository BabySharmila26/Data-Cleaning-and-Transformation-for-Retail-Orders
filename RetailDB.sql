...
-- 3)  For each category which month has highest sales
...
-- 5) Order by year(order_date),month(order_date)

select * from retailorders
order by year(Order_Date),month(Order_Date);

-- 6) Which sub category has highest growth by profit in 2023 compare to 2022
